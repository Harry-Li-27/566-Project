...
parser.add_argument("--output_dir", default=".", type=str, help="Path to save checkpoint.")
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    #    normalize
    #]
    t = transformscomp.trans_566("moco_1_rotate","moco_2_rotate")
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if ((epoch+1)%20==0) and (not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            }, is_best=False, filename='%scheckpoint_%04d.pth.tar' % (args.output_dir, epoch))
